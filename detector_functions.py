...
class KST_VNA_detector(Hard_Detector):

    def __init__(self, VNA, **kw):
        '''
        Detector function for the Keysight P9373A  VNA
        '''
        super(KST_VNA_detector, self).__init__()
        self.VNA = VNA
        self.value_names = ['ampl', 'phase',
                           'real', 'imag', 'ampl_dB']
        # self.value_names = ['ampl_dB', 'phase']
    ...
    def get_values(self):
        ...
        ampl_linear = np.abs(complex_data)
        ampl_dB = 20 * np.log10(ampl_linear)
        phase_radians = np.arctan2(imag_data, real_data)*180/np.pi

        return ampl_linear, phase_radians, real_data, imag_data, ampl_dB
        # return ampl_dB, phase_radians
        
class KST_VNA_QDac_list_detector(Hard_Detector):

    def __init__(self, VNA, qdac_ch1,qdac_ch2,**kw):
        '''
        Detector function for the Keysight P9373A  VNA
        '''
        super(KST_VNA_QDac_list_detector, self).__init__()
        self.VNA = VNA
        self.qdac_ch1 = qdac_ch1
        self.qdac_ch2 = qdac_ch2
        self.value_names = ['ampl', 'phase' ]
        # self.value_names = ['ampl_dB', 'phase']
        self.value_units = ['dB', 'degree']
        # self.value_units = ['dB', 'radians']
    ...
    def get_values(self):
        ...
        real_data_half = real_data[0:int(real_data.shape[0]/2)]#+np.flip(real_data[int(real_data.shape[0]/2-1):-1])
        imag_data_half = imag_data[0:int(imag_data.shape[0]/2)]#+np.flip(imag_data[int(real_data.shape[0]/2-1):-1])
        
        real_data = real_data_half
        imag_data = imag_data_half
        ...
        #qdac_ch1_dcv = np.array(self.qdac_ch1.dc_constant_V())
        #print(qdac_ch1_dcv,type(qdac_ch1_dcv))
        #qdac_ch2_dcv = np.array(self.qdac_ch2.dc_constant_V())
        #print(qdac_ch2_dcv,type(qdac_ch2_dcv))
        #print(ampl_dB,type(ampl_dB))

        return ampl_dB, phase_radians
        # return ampl_dB, phase_radians

class KST_VNA_QDac_list_yoga_step_detector(Hard_Detector):

    def __init__(self, VNA, qdac_ch1,yoga_instr,**kw):
        '''
        Detector function for the Keysight P9373A  VNA
        '''
        super(KST_VNA_QDac_list_yoga_step_detector, self).__init__()
        self.VNA = VNA
        self.qdac_ch1 = qdac_ch1
        self.yoga_instr = yoga_instr
        self.value_names = ['ampl', 'phase' ]
        # self.value_names = ['ampl_dB', 'phase']
        self.value_units = ['dB', 'degree']
        # self.value_units = ['dB', 'radians']
...
class KST_VNA_QDac_list_two_tone_detector(Hard_Detector):

    def __init__(self, VNA, qdac_ch1,**kw):
        '''
        Detector function for the Keysight P9373A  VNA
        '''
        super(KST_VNA_QDac_list_two_tone_detector, self).__init__()
        self.VNA = VNA
        self.qdac_ch1 = qdac_ch1
        #self.qdac_ch2 = qdac_ch2
        self.value_names = ['ampl', 'phase' ]
...
class KST_VNA_Anritsu_list_two_tone_detector(Hard_Detector):

    def __init__(self, VNA, Sgen,**kw):
        '''
        Detector function for the Keysight P9373A  VNA
        '''
        super(KST_VNA_Anritsu_list_two_tone_detector, self).__init__()
        self.VNA = VNA
        self.Sgen = Sgen
        #self.qdac_ch2 = qdac_ch2
        self.value_names = ['ampl', 'phase' ]
...
class KST_VNA_Anristu_two_tone_detector(Soft_Detector):

    def __init__(self, VNA, Anritsu, **kw):
        '''
        Detector function for the Keysight P9373A  VNA
        '''
        super( KST_VNA_Anristu_two_tone_detector, self).__init__()
        self.VNA = VNA
        self.awg = Anritsu
